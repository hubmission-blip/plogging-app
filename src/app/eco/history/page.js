...
const ECO_META = {
  ...
  quality_recycle:    { icon: Recycle,          title: "고품질 재활용품 배출", color: "text-cyan-500",    bg: "bg-cyan-50",    border: "border-cyan-200",   reward: 300 },
  phone_return:       { icon: Smartphone,      title: "폐휴대폰 반납",       color: "text-rose-500",    bg: "bg-rose-50",    border: "border-rose-200",   reward: 1000 },
  future_gen:         { icon: Sprout,          title: "미래세대 실천행동",    color: "text-green-500",   bg: "bg-green-50",   border: "border-green-200",  reward: 500 },
  shared_bike:        { icon: Bike,            title: "공유자전거 이용",      color: "text-lime-500",    bg: "bg-lime-50",    border: "border-lime-200",   reward: 100 },
  zero_waste:         { icon: UtensilsCrossed, title: "잔반제로 실천",       color: "text-orange-500",  bg: "bg-orange-50",  border: "border-orange-200", reward: 1000 },
  tree_planting:      { icon: TreePine,        title: "나무심기 캠페인 참여", color: "text-green-600",   bg: "bg-green-50",   border: "border-green-200",  reward: 3000 },
  solar_panel:        { icon: Sun,             title: "베란다 태양광 설치",   color: "text-yellow-500",  bg: "bg-yellow-50",  border: "border-yellow-200", reward: 10000 },
  recycled_product:   { icon: RotateCcw,       title: "재생원료 제품구매",    color: "text-teal-500",    bg: "bg-teal-50",    border: "border-teal-200",   reward: 100 },
  eco_bag:            { icon: ShoppingBag,     title: "개인장바구니 이용",    color: "text-pink-500",    bg: "bg-pink-50",    border: "border-pink-200",   reward: 50 },
  own_container:      { icon: Container,       title: "개인용기 식품포장",    color: "text-purple-500",  bg: "bg-purple-50",  border: "border-purple-200", reward: 500 },
};
