...
const VERIFY_PROMPTS = {
  tumbler: {
    pass: [
      "텀블러, 보온병, 다회용컵, 머그컵 등 재사용 가능한 음료 용기가 보이는 경우",
      "텀블러에 음료가 담겨 있거나 카페에서 텀블러를 사용하는 장면",
      "개인 컵/텀블러를 들고 있는 사람",
    ],
    fail: [
      "일회용 종이컵, 플라스틱 컵만 보이는 경우",
      "음료 용기가 전혀 보이지 않는 경우",
      "텀블러와 무관한 사진 (음식, 풍경 등)",
    ],
  },
...
판단 시 주의사항:
- 해당 물체가 작게 보이거나 배경에 있어도 인정합니다.
- 사진 품질이 다소 낮아도 대상이 식별 가능하면 인정합니다.
- 애매한 경우엔 사용자 편의를 위해 valid=true로 판단하세요.
