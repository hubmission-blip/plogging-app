...
export default function HomePage() {
  ...
  const handleShare = async () => {
    ...
    const shareText = myRefCode
      ? `"오백원의 행복"으로 삶을 느껴보세요.\n\n오백원의 행복 - 플로깅(Plogging)이란?\n조깅, 등산, 걷기 등 운동을 하면서 쓰레기(담배꽁초 등)를 줍기도 하는 환경보호운동입니다.\n지구를 지키고 포인트도 받아가세요!\n\n아래 링크로 가입하면 추가 보너스 포인트!\n\n${userName}님의 추천\n추천인 코드: ${myRefCode}\n${myRefUrl}`
      : `"오백원의 행복"으로 삶을 느껴보세요.\n\n오백원의 행복 - 플로깅(Plogging)이란?\n조깅, 등산, 걷기 등 운동을 하면서 쓰레기(담배꽁초 등)를 줍기도 하는 환경보호운동입니다.\n지구를 지키고 포인트도 받아가세요!`;
    try {
      if (navigator.share) {
    ...
    <>
      ...
      >
        ...
        <div className="px-4 mt-3 space-y-2">
          ...
          {/* ── 웰컴 / 로그인 유도 ── */}
          {user ? (
            <div className="bg-gradient-to-r rounded-2xl px-4 py-2 flex items-center justify-between text-white shadow-sm" style={{ backgroundImage: "linear-gradient(to right, #8dc63f, #4cb748)" }}>
              <div>
          ...
          <div className="rounded-2xl px-1.5 py-1.5" style={{ backgroundColor: "#8dc63f1a", border: "1px solid #8dc63f40" }}>
            <div className="grid grid-cols-2 gap-1.5">
              <div className="bg-white rounded-xl py-3 px-3 flex items-center justify-center gap-2.5" style={{ border: "1px solid #8dc63f30" }}>
                <Contact className="w-8 h-8 flex-shrink-0" strokeWidth={1.8} style={{ color: "#8dc63f" }} />
              ...
              <div className="bg-white rounded-xl py-3 px-3 flex items-center justify-center gap-2.5" style={{ border: "1px solid #8dc63f30" }}>
                <Route className="w-8 h-8 flex-shrink-0" strokeWidth={1.8} style={{ color: "#8dc63f" }} />
                <div className="leading-none text-left">
                  <span className="text-lg font-black block" style={{ color: "#6ba030" }}>
